...
function DxfParser(stream) {
    ...
    this.parseSync = function (source) {
     ...
     */
    this.getAcadColor = function (index) {
        return AUTO_CAD_COLOR_INDEX[index];
    }


    this.parse = function (dxfString) {
            ...
            while (!groupIs(0, 'ENDTAB')) {
                ...
                switch (curr.code) {
                    ...
                    case 62: // color, visibility
                       ...
                       // layer.color = this.getAcadColor(Math.abs(curr.value));
                        curr = scanner.next();
                        break;
                    case 0:
                        // New Layer
    ...
    this.parseStream = function (stream, done) {
    ...
    this.logUnhandledGroup = function(curr) {
       // log.debug('unhandled group ' + debugCode(curr));
    }


    this.debugCode = function(curr) {
